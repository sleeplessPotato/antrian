...
INSERT INTO "new_Queue" ("callCount", "calledAt", "counterId", "createdAt", "date", "doneAt", "id", "nik", "number", "phone", "prefix", "queueType", "servedAt", "serviceId", "status", "visitorName") SELECT "callCount", "calledAt", "counterId", "createdAt", "date", "doneAt", "id", "nik", "number", "phone", "prefix", "queueType", "servedAt", "serviceId", "status", "visitorName" FROM "Queue";
DROP TABLE "Queue";
